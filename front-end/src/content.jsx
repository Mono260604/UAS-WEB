    ...
    <>
      <div className="w-full m-0  bg-body pt-14 mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8 px-4 py-4">
          <div className="border bg-product container w-full md:w-64 h-64 mx-auto md:ml-24 flex items-center justify-center">
            product
          </div>
          ...
          <div className="border bg-product container w-full md:w-64 h-64 mx-auto md:mr-24 flex items-center justify-center">
            product
          </div>
        </div>
